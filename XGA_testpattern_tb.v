// XGA_testpattern_tb.v
// --------------------------------------------------------------
// Tool Version: Quartus 18.1 / ModeSim-Altera 10.5b
// Design      : XGA_testpattern_tb
// Syntax Ver  : SystemVerilog
// Purpose     : Save each output frame as a BMP file.
//
// -------------------------- Updates --------------------------- 
// | Ver. | Date       | Author      | Comments
// | 1.0  | 03/30/2020 | Victor Gan  | Fit XGA_testpattern
// | 0.9  | 03/30/2020 | Victor Gan  | Copied from XGA_tb.v
// --------------------------------------------------------------
...
module XGA_testpattern_tb();
   ...
   initial begin
      ...
      // Generate BLACK.BMP
      $display("Creating pattern.bmp");
      pattern = $fopen("pattern.bmp", "wb");
      fopen_check(pattern, "pattern.bmp");
      print_frame(pattern, patterndone);
      $fclose(pattern);
      @(posedge clk_75);
   end
